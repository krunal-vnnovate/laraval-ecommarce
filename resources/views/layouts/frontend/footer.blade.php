                    ...
                    <div class="col-xl-3 col-md-6 col-12">
                        <div class="footer-infor">
                            <div class="footer-logo">
                                <a href="index.html">
                                    <img src="{{asset('assets/frontend/images/logo/RaviPrintersLogo.png')}}" alt="Ravi Printers" width="45%">
                                </a>
                            </div>
                            <ul>
                                <li>
                                    <p>Address: FF-11, Ravi Printers, <br> Jagtpur, Vandematram - Ahmedabad 381482</p>
                                </li>
                                <li>
                                    <p>Email: <a href="home-giftcard.html#">raviprinters21@gmail.com</a></p>
                                </li>
                                <li>
                                    <p>Phone: <a href="home-giftcard.html#">(+91) 94280 36524</a></p>
                                </li>
                            </ul>
                            <a href="contact-1.html" class="tf-btn btn-line">Get direction<i class="icon icon-arrow1-top-left"></i></a>
                            <ul class="tf-social-icon d-flex gap-10">
                                <li><a href="home-giftcard.html#" class="box-icon w_34 round social-facebook social-line"><i class="icon fs-14 icon-fb"></i></a></li>
                                <li><a href="home-giftcard.html#" class="box-icon w_34 round social-twiter social-line"><i class="icon fs-12 icon-Icon-x"></i></a></li>
                                <li><a href="home-giftcard.html#" class="box-icon w_34 round social-instagram social-line"><i class="icon fs-14 icon-instagram"></i></a></li>
                                <li><a href="home-giftcard.html#" class="box-icon w_34 round social-tiktok social-line"><i class="icon fs-14 icon-tiktok"></i></a></li>
                                <li><a href="home-giftcard.html#" class="box-icon w_34 round social-pinterest social-line"><i class="icon fs-14 icon-pinterest-1"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 col-12">
                        <div class="footer-newsletter footer-col-block">
                            ...
                            <div class="tf-collapse-content">
                                ...
                                <form class="form-newsletter" id="subscribe-form" action="home-giftcard.html#" method="post" accept-charset="utf-8" data-mailchimp="true">

...
<section class="flat-spacing-11">
    <div class="container">
        <div class="tf-page-cart-wrap layout-2">
                ...
                @csrf
                    <div class="box grid">
                        <fieldset class="fieldset">
                            ...
                            <input type="text" id="first-name" placeholder="Enter Your Full Name Here..." value="{{Auth::user()->name}}">
                        </fieldset>
                    </div>
                    ...
                    <fieldset class="box fieldset">
                        ...
                        <input type="text" id="city" placeholder="Please Enter Your City/Town">
                    </fieldset>
                    <fieldset class="box fieldset">
                        <label for="address">Address</label>
                        <input type="text" id="address" placeholder="Please Enter Your Delivery Address">
                    </fieldset>
                    <fieldset class="box fieldset">
                        <label for="phone">Phone Number</label>
                        <input type="number" id="phone" placeholder="Please Enter Your Contact Number... (Whatsapp)">
                    </fieldset>
                    <fieldset class="box fieldset">
                        <label for="email">Email</label>
                        <input type="email" id="email" placeholder="Please Enter Your Registerd Email Address" value="{{Auth::user()->email}}">
                    </fieldset>
                    <fieldset class="box fieldset">
                    ...
                    <fieldset class="box fieldset">
                        <h6><span class="text-danger">If Any changes may occur then please <b>update us on email/whatsapp</b>.</span></h5>
                    </fieldset>
                </form>
            </div>
            <!-- /Geeting Delivery Details -->

            <!-- Display Selected Items on cart In Right side -->
                        ...
                        <ul class="wrap-checkout-product">
                            ...
                            <li class="checkout-product-item">
                                <figure class="img-product">
                                    <img src="/{{$value->product->product_img}}" alt="{{$value->product->product_name}}">
                                    <!-- <span class="quantity">1</span> -->
                                </figure>
                                <div class="content">
                                    <div class="info">
                                        <p class="name">{{$value->product->product_name}}</p>
                                    </div>
                                    <span class="price">{{$value->product->product_price}}</span>
                                </div>
                            </li>
                            <?php
                            $total = $total+$value->product->product_price;
                            ?>
                            @endforeach
                        </ul>
            ...
            <!-- /sDisplay Selected Items on cart In Right side -->

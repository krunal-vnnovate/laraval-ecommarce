                        ...
                        <tbody>
                            ...
                            <tr class="tf-cart-item file-delete">
                                <td class="tf-cart-item_price" cart-data-title="Price">
                                    <div class="cart-price">{{$key+1}}</div>
                                </td>
                                <td>
                                    <div class="cart-info">
                                        <a href="#" class="cart-title link">{{$value->product->product_name}}</a>
                                        <span class="remove-cart link remove">Remove</span>
                                    </div>
                                </td>
                                <td class="tf-cart-item_price" cart-data-title="Price">
                                    <div class="cart-price">₹{{$value->product->product_price}}</div>
                                </td>
                                ...
                                <td class="tf-cart-item_product">
                                    <a href="product-detail.html" class="img-box">
                                        <img src="/{{$value->product->product_img}}" alt="img-product" width="200px">
                                    </a>
                                </td>
                                <td class="tf-cart-item_product">
                                    <a href="{{'/frontend/cart/delete/'.$value->id}}" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                ...
                <div class="tf-cart-footer-inner">
                    <div class="tf-free-shipping-bar">
                        ...
                        <div class="tf-progress-msg">
                            Buy <span class="price fw-6">₹{{$total}}</span> more to enjoy <span class="fw-6">Free Shipping</span>
                        </div>
                    </div>
                    <div class="tf-page-cart-checkout">
                        ...
                        <div class="cart-checkout-btn">
                            <button type="submit"><a href="{{'/frontend/orders/'.$value->id}}" class="tf-btn w-100 btn-fill animate-hover-btn radius-3 justify-content-center"><span>Check out</span></a></button>
                        </div>
